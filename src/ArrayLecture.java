...
//            System.out.println("sidesArray[120] = " + sidesArray[120]); // WE WILL GET AN ERROR! OUT OF BOUNDS!
            ...
            String[] cohorts = {"Marco","Oberton","Neptune", "Polaris"};

           System.out.print("Hey, good to see you today " + cohorts[0] + " students! Did you know our upcoming cohort is going to be named " + cohorts[3] + "?");
            ...
            String[] exercises = {"barbell squats","dumbbell squats","Ez bar curls", "deadlifts"};
            System.out.println();
            ...
            for(int i = 0; i < cohorts.length; i++) {
                System.out.println();
               System.out.println("Codeup has a number of different cohorts! one of them is the " + cohorts[i] + " cohort.");
            }
            ...
            for (String cohort : cohorts){ // for(datatype singular : arrName){ do some stuff
                System.out.println("Codeup runs a few a cohorts at a time - one of the ones from 2021 is " + cohort);
            }
            ...
            for (String weight : exercises) {
                System.out.println("These are some exercises you can implement into your workout routine: " + weight);
            }
